...
function fillTable(tbname:string, nblines:number, mult:number) {
...
document.addEventListener("DOMContentLoaded", function() {
	...
	const uimodeSelect:HTMLSelectElement|null=(document.getElementById("uimode") as HTMLSelectElement);
	...
	function onUpdate(elt:HTMLElement) {
