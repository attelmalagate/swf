...
class _edtb {
	...
	constructor(onUpdate, poptions){
		// options management
		this.options = poptions || {};
		this.options.backgroundColor = (poptions.backgroundColor === undefined) ? _def_BGCOLOR : poptions.backgroundColor;
		this.options.borderRadius = (poptions.borderRadius === undefined) ? _def_BORDERRADIUS : poptions.borderRadius;
		this.options.border = (poptions.border === undefined) ? _def_BORDER : poptions.border;
		this.options.cursor = (poptions.cursor === undefined) ? _def_CURSOR : poptions.cursor;
		// seconds of inactivity in edit mode before reverting to consult
		this.options.toutMax = (poptions.toutMax === undefined) ? _def_TOUTMAX : poptions.toutMax;
